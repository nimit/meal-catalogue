...
//Note:
//removeMeal is part of the example - popping a page and sending info through popped pages.
...
class MealItem extends StatelessWidget {
  ...
  void selectMeal(BuildContext context) {
    ...
    //.then is used when the <Future> data type returns a value. In pushNamed, the value is returned when popped.
          ...
          children: [
            Stack(
              children: [
                ...
                Positioned(
                  //To have it in the bottom right corner
                  bottom: 20,
                  right: 10,
                  child: Container(
                    width: 300,
